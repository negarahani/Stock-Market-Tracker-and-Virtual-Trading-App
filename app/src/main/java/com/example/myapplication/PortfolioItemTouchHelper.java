...
public class PortfolioItemTouchHelper extends ItemTouchHelper.Callback {

    private final MainActivity activity;
    private final SectionedRecyclerViewAdapter adapter;

    public PortfolioItemTouchHelper(MainActivity activity, SectionedRecyclerViewAdapter adapter) {
